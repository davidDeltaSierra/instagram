...
@With
@Value
public class NodeDto<T extends NextPageHandler> implements NextPageHandler {
    T node;
    ...
    @JsonCreator
    public static <T extends NextPageHandler> NodeDto<T> jsonCreator(@JsonProperty("node") T node) {
